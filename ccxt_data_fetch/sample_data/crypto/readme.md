...
`tickType` in this documentation can refer to one of the following:
please according to @ccxt_data_fetch/README.md to implement future data fetcher with ccxt. you just need to implement 'cryptofuture' data from 'binance' with frequency of ['daily','hour','margin_interest','minute'], `tickType` should contain [`trade`, `quote`]. implement spot data fetcher with ccxt. you just need to implement 'crypto' data from 'binance' with frequency of ['daily','hour','minute']